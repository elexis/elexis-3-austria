...
public class VaebCodeSelectorFactory extends CodeSelectorFactory {
	SelectorPanelProvider slp;
	CommonViewer cv;
	
	public VaebCodeSelectorFactory(){
	...
	public ViewerConfigurer createViewerConfigurer(CommonViewer cv){
		this.cv = cv;
		ViewerConfigurer vc =
			new ViewerConfigurer(new KassenLeistungTreeContentProvider(VaebLeistung.class),
