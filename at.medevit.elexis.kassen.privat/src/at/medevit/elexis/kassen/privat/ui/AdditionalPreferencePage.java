...
public class AdditionalPreferencePage extends FieldEditorPreferencePage implements
	...
	public void init(IWorkbench workbench){
		...
		setDescription("Einstellungen zu privaten Zusatzversicherungen. Der konfigurierte Zuschlag wird pro verrechneter Leistung aufgeschlagen.");
	}
...
// create a composite
		...
		titel.setText("Private Zusatzversicherungen:");
...
// create a table viewer
		...
		viewerColumn.setLabelProvider(new ColumnLabelProvider() {
			...
			public String getText(Object element){
				AdditionalInsurance additional = (AdditionalInsurance) element;
		...
		viewerColumn.setLabelProvider(new ColumnLabelProvider() {
			...
			public String getText(Object element){
				...
				sb.append(additional.getValueAsString());
				sb.append(" ");
				sb.append(additional.getValueType().getPostfix());
				return sb.toString();
			}
		});
		
		viewer.setContentProvider(new ArrayContentProvider());
		viewer.setInput(AdditionalInsurance.getAll());
...
// Then add the actions for PointsArea
		menuManager.add(new Action() {
			...
			@Override
			public void run(){
				EditAdditionalInsuranceDialog dialog =
					new EditAdditionalInsuranceDialog(parent.getShell(), null);
				dialog.create();
		...
		menuManager.add(new Action() {
			...
			public void run(){
				...
				if (selection != null & selection instanceof IStructuredSelection) {
					...
					EditAdditionalInsuranceDialog dialog =
						new EditAdditionalInsuranceDialog(parent.getShell(), sel);
					dialog.create();
					if (dialog.open() == Window.OK) {
						viewer.setInput(AdditionalInsurance.getAll());
						viewer.refresh();
