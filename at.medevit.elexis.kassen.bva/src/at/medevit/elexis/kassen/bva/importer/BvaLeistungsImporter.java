 ...
 *******************************************************************************/
package at.medevit.elexis.kassen.bva.importer;
...
public class BvaLeistungsImporter extends ImporterPage {
	...
	public IStatus doImport(IProgressMonitor monitor) throws Exception {
		...
		try {			
			...
			monitor.beginTask("Importiere BVA Honorartarife", IProgressMonitor.UNKNOWN);

			for(LeistungBean leistung : leistungen) {
				new BvaLeistung(leistung);
			}
			monitor.done();
