 ...
 *******************************************************************************/
package at.medevit.elexis.kassen.sva.model;
...
public class SvaLeistung extends KassenLeistung {

	protected static final String TABLENAME = "at_medevit_elexis_kassen_SVA_leistungen";
	...
	protected static final String createDB =
		"CREATE TABLE " + TABLENAME + "("
			...
			+ "positionlogik		TEXT"
			+ ");" 		  
			+ "CREATE INDEX SVAIDX1 ON " + TABLENAME + " (positionid);"
	...
	static {
		...
		SvaLeistung version = load("VERSION");
...
//			}
	...
	protected SvaLeistung(final String id){
		super(id);
	}
	
	public SvaLeistung(LeistungBean leistung) {
		 create(null);
		 setLeistungFromBean(leistung);
	}

	public static SvaLeistung load(final String id){
		return new SvaLeistung(id);
	}
