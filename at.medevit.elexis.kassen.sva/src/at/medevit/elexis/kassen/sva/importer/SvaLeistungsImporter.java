 ...
 *******************************************************************************/
package at.medevit.elexis.kassen.sva.importer;
...
public class SvaLeistungsImporter extends ImporterPage {
	...
	public IStatus doImport(IProgressMonitor monitor) throws Exception {
		...
		try {			
			...
			monitor.beginTask("Importiere SVA Honorartarife", IProgressMonitor.UNKNOWN);

			for(LeistungBean leistung : leistungen) {
				new SvaLeistung(leistung);
			}
			monitor.done();
