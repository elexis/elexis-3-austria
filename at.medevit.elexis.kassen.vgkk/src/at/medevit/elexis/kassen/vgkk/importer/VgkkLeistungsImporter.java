 ...
 *******************************************************************************/
package at.medevit.elexis.kassen.vgkk.importer;
...
public class VgkkLeistungsImporter extends ImporterPage {
	...
	public IStatus doImport(IProgressMonitor monitor) throws Exception {
		...
		try {			
			...
			monitor.beginTask("Importiere VGKK Honorartarife", IProgressMonitor.UNKNOWN);

			for(LeistungBean leistung : leistungen) {
				new VgkkLeistung(leistung);
			}
			monitor.done();
